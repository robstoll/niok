...
[![Build Status Travis](https://travis-ci.org/robstoll/niok.svg?tag=v1.3.0)](https://travis-ci.org/robstoll/niok/branches)
...
dependencies {
    implementation 'ch.tutteli.niok:niok:1.3.0'
}
```
